...
import 'package:big_shelf/view/cart_bottomSheet/cart_card.dart';
import 'package:big_shelf/view/cart_bottomSheet/sheet_header.dart';
import 'package:big_shelf/view/checkout_screen/checkout_screen-1.dart';
import 'package:big_shelf/view/checkout_screen/checkout_screen.dart';
                ...
                child: Obx(
                  () => Stack(
                    children: [
                      ...
                      if (_swipeUp && controller.cart.length > 0)
                        Positioned(
